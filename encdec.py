...
class Decoder(EncoderDecoderBase):
    ...
    def build_decoder_alignment(self, c, y,
            c_mask=None,
            y_mask=None,
            step_num=None,
            mode=EVALUATION,
    ...
    def build_next_probs_predictor_align(self, c, step_num, y, init_states):
        return self.build_decoder_alignment(c, y, mode=Decoder.BEAM_SEARCH, given_init_states=init_states, step_num=step_num)
            ...
            self.next_probs_fn = theano.function(
                    ...
                    outputs=[self.decoder.build_next_probs_predictor(
                        self.c, self.step_num, self.gen_y, self.current_states),
                            self.decoder.build_next_probs_predictor_align(
                        self.c, self.step_num, self.gen_y, self.current_states)],
                    name="next_probs_fn")
